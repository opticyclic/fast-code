...
public class CreateSimilarDAOServicePojoPreferencePage extends CreateSimilarPojoPreferencePage {

	public CreateSimilarDAOServicePojoPreferencePage() {
		super();
		this.preferenceId = CREATE_SIMILAR_PREFERENCE_POJO_DAO_SERVICE_ID;
		this.setDescription("Create similar preference page For Dao to Service POJOs");
	}
	...
	public void createFieldEditors() {
		...
		final BooleanFieldEditor afterFinish = new BooleanFieldEditor(getPreferenceLabel(P_NEXT_DESCRIPTOR, this.preferenceId),
				"After completion, apply the service to GUI POJO action :", this.getFieldEditorParent());
