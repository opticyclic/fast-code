...
public final class ResourceManager {
	...
	private static final RGB					RGB_GROUP			= new RGB(128, 192, 96);
	...
	static {
		...
		attributes.put(GROUP, new TextAttribute(colorManager.getColor(RGB_GROUP), null, SWT.ITALIC));
	 ...
	 * @return the image
	 */
	/*    public static Image getImage(final String imageFile) {
