...
public class CreateHqlUpdateViewAction extends CreateHqlGenericViewAction {

	/**
	 *
	 */
	public CreateHqlUpdateViewAction() {
		this.templateType = TEMPLATE_TYPE_CREATE_HQL_UPDATE;
	...
	protected String[] getFieldTypesForHql() {
		return new String[] { "update_fields", "where_fields" };
	}
