...
public class CreateNewDatabaseInsertWithNamedParameterAction extends AbstractCreateNewDatabaseSnippetAction implements
		IEditorActionDelegate, IActionDelegate, IWorkbenchWindowActionDelegate {
	/**
	 *
	 */
	public CreateNewDatabaseInsertWithNamedParameterAction() {
		this.templatePrefix = P_DATABASE_TEMPLATE_PREFIX;
		this.templateType = DATABASE_TEMPLATE_INSERT_WITH_NAMED_PARAMETER;
	}
}
