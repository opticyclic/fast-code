...
public class CreateNewDatabaseSimpleSnippetAction extends AbstractCreateNewDatabaseSnippetAction implements IEditorActionDelegate,
		IActionDelegate, IWorkbenchWindowActionDelegate {

	public CreateNewDatabaseSimpleSnippetAction() {
		this.templatePrefix = P_DATABASE_TEMPLATE_PREFIX;
		this.templateType = DATABASE_TEMPLATE_SIMPLE_SNIPPET;
	}
}
